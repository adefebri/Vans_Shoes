package com.example.febri.martabor;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickPesan(View v){
        ...
        startActivity(intent); // Pindah Intent saat memencet CardView yang sudah diberi onClick bernama onClickPesan
    }

    public void onClickTOpMenu(View v){
        Intent intent = new Intent(MainActivity.this,TopMenuActivity.class);
        startActivity(intent);  // Pindah Intent saat memencet CardView yang sudah diberi onClick bernama onClickTopMeny
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) { //Disini baru membuat menu inflatternya
        switch (item.getItemId()){
            ...
            case R.id.order: //Jika yang diklik order maka ke profil activity order
                Intent order = new Intent(this, com.example.febri.martabor.OrderActivity.class);
                startActivity(order);
                break;
            case R.id.topMenu:
